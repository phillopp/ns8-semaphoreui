...
Instantiate the module with:
    ...
    add-module ghcr.io/phillopp/semaphoreui:latest 1

The output of the command will return the instance name.
Output example:

    {"module_id": "semaphoreui1", "image_name": "semaphoreui", "image_url": "ghcr.io/phillopp/semaphoreui:latest"}
...
To Update the instance:
    ...
    api-cli run update-module --data '{"module_url":"ghcr.io/nethserver/semaphoreui:latest","instances":["semaphoreui1"],"force":true}'
